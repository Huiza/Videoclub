                            ...
                            <div class="form-example-wrap">
                                <form action="{{route('guardar_pelicula')}}" method="POST" >
                                    ...
                                    <div class="form-group ic-cmp-int">
                                        ...
                                        <div class="nk-int-st">
                                            <input type="text" class="form-control" name="titulo" placeholder="Título de la película" value="{{old('titulo')}}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group ic-cmp-int">
                                        ...
                                        <div class="nk-int-st">
                                            <input type="text" class="form-control" name="anio_estreno" placeholder="Año de estreno" value="{{old('anio_estreno')}}">
                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                            <div class="bootstrap-select fm-cmp-mg">
                                                <select class="selectpicker" name="categoria_id">
                                                    ...
                                                    <option value="{{$categoria->id}}" {{ (old('categoria_id') == $loop->iteration ? "selected":"") }}>{{$categoria->nombre_categoria}}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                    ...
                                    <br><br><br>
                            <div class="form-example-int mg-t-15">
                                <button class="btn btn-success notika-btn-success">Guardar pelicula</button>
